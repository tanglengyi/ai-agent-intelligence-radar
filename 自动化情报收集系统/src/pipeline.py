...
from event_merger import EventMerger, write_jsonl as write_event_jsonl
...
class IntelligencePipeline:
    """One-command pipeline for collection, evaluation, merge and report generation."""
    ...
    def run(self) -> Dict[str, Any]:
        ...
        report = self.generate_daily_report(merged_events)
        summary = self.build_summary(raw_items, evaluated_items, merged_events)
